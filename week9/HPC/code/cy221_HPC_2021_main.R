...
question_8 <- function() {
  ...
  plot(model,pch=16,cex=0.5, col="blue",xlab="Time(Generation)",ylab="Species richness per generation", main="Time series graph of neutral model simulation with intial condition of maximal diveristy, size = 100, generations = 200",cex.main =0.7)
...
process_cluster_results <- function()  {
  ...
  data_octave <- list()
  for (i in 1:100){
    file <- paste0("./results/HPC_cluster_rda/cy221_cluster_run_", i , "_.rda")
    load(file,.GlobalEnv)
...
plot_cluster_results <- function()  {
    ...
    # plot the graphs
  graphics.off()
  load("./code/combined_results.rda")
  par(mfrow = c(2, 2))
  ...
  barplot(height=plot_500,ylim=c(0,1.5), xlab="", ylab="Number of Species", main="Mean species abdunace octave from cluster runs for community size=500",cex.main=0.6, col=c("pink"),cex.names=0.8,las=2, cex.axis=0.8)
  mtext("Number of individuals per species",side=1, line=4, cex=0.8)
  ...
  barplot(height=plot_1000,ylim=c(0,3), xlab="", ylab="Number of Species", main="Mean species abdunace octave from cluster runs for community size=1000",cex.main=0.6, col=c("blue"),cex.names=0.8,las=2, cex.axis=0.8)
  mtext("Number of individuals per species",side=1, line=4, cex=0.8)
  ...
  barplot(height=plot_2500,ylim=c(0,7), xlab="", ylab="Number of Species", main="Mean species abdunace octave from cluster runs for community size=2500",cex.main=0.6, col=c("grey"),cex.names=0.8,las=2, cex.axis=0.8)
  mtext("Number of individuals per species",side=1, line=4, cex=0.8)
  ...
  barplot(height=plot_5000,ylim=c(0,14), xlab="", ylab="Number of Species", main="Mean species abdunace octave from cluster runs for community size=5000",cex.main=0.6, col=c("green"),cex.names=0.8,las=2, cex.axis=0.8)
  mtext("Number of individuals per species",side=1, line=4, cex=0.8)
